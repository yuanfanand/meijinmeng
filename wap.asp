...
%>
<div id="ft">Powered By <a href="http://meijinmeng.cn/">美金梦</a>&nbsp;&nbsp;<a href="<%=BlogHost%>?mod=pad">触屏版</a>&nbsp;|&nbsp;<a href="<%=BlogHost%>?mod=wap" style="text-decoration:underline">WAP版</a>&nbsp;|&nbsp;<a href="<%=BlogHost%>?mod=pc">电脑版</a></div>
</body>
</html>